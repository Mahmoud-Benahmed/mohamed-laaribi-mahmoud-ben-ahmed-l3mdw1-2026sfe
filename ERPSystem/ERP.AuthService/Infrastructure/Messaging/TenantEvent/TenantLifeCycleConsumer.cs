...
public sealed class TenantLifecycleConsumer : BackgroundService
{
        ...
        ILogger<TenantLifecycleConsumer> logger)
    {
        ...
        _consumer.Subscribe(new[] { TenantTopics.TenantCreated, TenantTopics.TenantUpdated, TenantTopics.TenantDeleted });
    }
    ...
    private async Task HandleTenantCreated(string payload, IServiceScope scope)
    {
        ...
        await tenantCacheService.SyncCreatedAsync(evt);
    ...
    private async Task HandleTenantUpdated(string payload, IServiceScope scope)
    {
        ...
        var tenantCacheService= scope.ServiceProvider.GetRequiredService<ITenantCacheService>();
        await tenantCacheService.SyncUpdatedAsync(evt);
